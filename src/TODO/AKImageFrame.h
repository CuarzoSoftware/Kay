 ...
 *
 * This class is a subclass of `AKContainer` and internally uses an `AKImage` child node to render
 * the image. The position and dimensions of the `AKImage` are automatically calculated and updated
 ...
 *
 * @note Since `AKImage` is used internally, no additional buffering is required for displaying
 * images, making this class efficient for rendering.
 */
class CZ::AKImageFrame : public AKContainer
{
public:
    /**
     ...
     *
     * If the image is `nullptr`, the internal `AKImage` will be hidden,
     ...
     *
     * @param transform The transform to apply. Defaults to `CZ::CZTransform::Normal`.
     */
     ...
     *
     * @return The current transform. Defaults to `CZ::CZTransform::Normal`.
     */
     ...
     */
    bool setSrcRectMode(AKImage::SrcRectMode mode) noexcept
    {
     ...
     */
    AKImage::SrcRectMode srcRectMode() const noexcept
    {
    ...
    /**
     * @brief Enables or disables automatic damage tracking for the `AKImage`.
     *
     * When enabled, the `AKImage` will automatically mark itself as damaged when properties
    ...
    /**
     * @brief Checks if automatic damage tracking is enabled for the `AKImage`.
     *
    ...
    /**
     * @brief Retrieves the internal `AKImage` component.
     *
     * @return A const reference to the internal `AKImage`.
     */
    const AKImage &renderableImage() const noexcept
    {
     ...
     * @brief Retrieves the internal `AKImage` component.
     *
     * @return A mutable reference to the internal `AKImage`.
     */
    AKImage &renderableImage() noexcept
    {
        return m_renderableImage;
    }

    /**
     * @brief Retrieves the opaque region of the `AKImage`.
     *
     * @return A reference to the opaque region of the `AKImage`.
     */
