#ifndef CZ_AKBACKGROUNDDAMAGETRACKER_H
#define CZ_AKBACKGROUNDDAMAGETRACKER_H
 ...
 * the content behind them. It only captures the content while enabled
 ...
 * directly into the scene target as usual. Instead, it is rendered into an RSurface
 ...
 */
class CZ::AKBackgroundDamageTracker : public AKObject
{
public:
     ...
     */
    const std::unordered_map<AKTarget*,std::shared_ptr<RSurface>> &surfaces() const noexcept
    {
        return m_surfaces;
    }
     ...
     */
    std::shared_ptr<RSurface> currentSurface() const noexcept
    {
...
private:
    ...
    std::unordered_map<AKTarget*,std::shared_ptr<RSurface>> m_surfaces;
    std::shared_ptr<RSurface> m_currentSurface;
    bool m_enabled { false };
};

#endif // CZ_AKBACKGROUNDDAMAGETRACKER_H
