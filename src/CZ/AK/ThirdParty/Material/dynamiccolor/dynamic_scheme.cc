...
#include "CZ/AK/ThirdParty/Material/cam/hct.h"
#include "CZ/AK/ThirdParty/Material/dynamiccolor/material_dynamic_colors.h"
#include "CZ/AK/ThirdParty/Material/dynamiccolor/variant.h"
#include "CZ/AK/ThirdParty/Material/palettes/tones.h"
#include "CZ/AK/ThirdParty/Material/utils/utils.h"
...
Argb DynamicScheme::GetColor(CZ::AKColorRole role) const
{
    switch (role) {
    // --- Palette key colors ---
    case CZ::AKColorRole::PrimaryPaletteKeyColor: return GetPrimaryPaletteKeyColor();
    case CZ::AKColorRole::SecondaryPaletteKeyColor: return GetSecondaryPaletteKeyColor();
    case CZ::AKColorRole::TertiaryPaletteKeyColor: return GetTertiaryPaletteKeyColor();
    case CZ::AKColorRole::NeutralPaletteKeyColor: return GetNeutralPaletteKeyColor();
    case CZ::AKColorRole::NeutralVariantPaletteKeyColor: return GetNeutralVariantPaletteKeyColor();

        // --- Background & surfaces ---
    case CZ::AKColorRole::Background: return GetBackground();
    case CZ::AKColorRole::OnBackground: return GetOnBackground();
    case CZ::AKColorRole::Surface: return GetSurface();
    case CZ::AKColorRole::SurfaceDim: return GetSurfaceDim();
    case CZ::AKColorRole::SurfaceBright: return GetSurfaceBright();
    case CZ::AKColorRole::SurfaceContainerLowest: return GetSurfaceContainerLowest();
    case CZ::AKColorRole::SurfaceContainerLow: return GetSurfaceContainerLow();
    case CZ::AKColorRole::SurfaceContainer: return GetSurfaceContainer();
    case CZ::AKColorRole::SurfaceContainerHigh: return GetSurfaceContainerHigh();
    case CZ::AKColorRole::SurfaceContainerHighest: return GetSurfaceContainerHighest();
    case CZ::AKColorRole::OnSurface: return GetOnSurface();
    case CZ::AKColorRole::SurfaceVariant: return GetSurfaceVariant();
    case CZ::AKColorRole::OnSurfaceVariant: return GetOnSurfaceVariant();
    case CZ::AKColorRole::InverseSurface: return GetInverseSurface();
    case CZ::AKColorRole::InverseOnSurface: return GetInverseOnSurface();
    case CZ::AKColorRole::Outline: return GetOutline();
    case CZ::AKColorRole::OutlineVariant: return GetOutlineVariant();
    case CZ::AKColorRole::Shadow: return GetShadow();
    case CZ::AKColorRole::Scrim: return GetScrim();
    case CZ::AKColorRole::SurfaceTint: return GetSurfaceTint();

        // --- Primary ---
    case CZ::AKColorRole::Primary: return GetPrimary();
    case CZ::AKColorRole::OnPrimary: return GetOnPrimary();
    case CZ::AKColorRole::PrimaryContainer: return GetPrimaryContainer();
    case CZ::AKColorRole::OnPrimaryContainer: return GetOnPrimaryContainer();
    case CZ::AKColorRole::InversePrimary: return GetInversePrimary();

        // --- Secondary ---
    case CZ::AKColorRole::Secondary: return GetSecondary();
    case CZ::AKColorRole::OnSecondary: return GetOnSecondary();
    case CZ::AKColorRole::SecondaryContainer: return GetSecondaryContainer();
    case CZ::AKColorRole::OnSecondaryContainer: return GetOnSecondaryContainer();

        // --- Tertiary ---
    case CZ::AKColorRole::Tertiary: return GetTertiary();
    case CZ::AKColorRole::OnTertiary: return GetOnTertiary();
    case CZ::AKColorRole::TertiaryContainer: return GetTertiaryContainer();
    case CZ::AKColorRole::OnTertiaryContainer: return GetOnTertiaryContainer();

        // --- Error ---
    case CZ::AKColorRole::Error: return GetError();
    case CZ::AKColorRole::OnError: return GetOnError();
    case CZ::AKColorRole::ErrorContainer: return GetErrorContainer();
    case CZ::AKColorRole::OnErrorContainer: return GetOnErrorContainer();

        // --- Fixed variants ---
    case CZ::AKColorRole::PrimaryFixed: return GetPrimaryFixed();
    case CZ::AKColorRole::PrimaryFixedDim: return GetPrimaryFixedDim();
    case CZ::AKColorRole::OnPrimaryFixed: return GetOnPrimaryFixed();
    case CZ::AKColorRole::OnPrimaryFixedVariant: return GetOnPrimaryFixedVariant();

    case CZ::AKColorRole::SecondaryFixed: return GetSecondaryFixed();
    case CZ::AKColorRole::SecondaryFixedDim: return GetSecondaryFixedDim();
    case CZ::AKColorRole::OnSecondaryFixed: return GetOnSecondaryFixed();
    case CZ::AKColorRole::OnSecondaryFixedVariant: return GetOnSecondaryFixedVariant();

    case CZ::AKColorRole::TertiaryFixed: return GetTertiaryFixed();
    case CZ::AKColorRole::TertiaryFixedDim: return GetTertiaryFixedDim();
    case CZ::AKColorRole::OnTertiaryFixed: return GetOnTertiaryFixed();
    case CZ::AKColorRole::OnTertiaryFixedVariant: return GetOnTertiaryFixedVariant();
    }
