...
public:
     ...
     *
     * This is equivalent to calling `states().has(AKMaximized)`.
     *
     ...
     *
     * This is equivalent to calling `states().has(AKFullscreen)`.
     *
     ...
     * @see onWMCapabilitiesChanged
     */
    CZBitset<WMCapabilities> wmCapabilities() const noexcept;
     ...
     */
    CZSignal<const CZWindowStateEvent&> onStatesChanged;
     ...
     */
    CZSignal<> onSuggestedSizeChanged;
     ...
     */
    CZSignal<> onSuggestedBoundsChanged;
     ...
     */
    CZSignal<> onWMCapabilitiesChanged;
