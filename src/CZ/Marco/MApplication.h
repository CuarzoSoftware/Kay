...
#include <CZ/Marco/input/MKeyboard.h>
...
#include <CZ/Marco/protocols/lvr-background-blur-client.h>
...
class CZ::MApplication : public AKApp
{
public:
    struct Wayland
    {
    ...
    MPointer &pointer() noexcept { return (MPointer&)AKApp::pointer(); }
    MKeyboard &keyboard() noexcept { return(MKeyboard&)AKApp::keyboard(); }
...
private:
    ...
    std::shared_ptr<CZBooleanEventSource> m_marcoSource;
    CZEventSource *m_waylandEventSource { nullptr };
