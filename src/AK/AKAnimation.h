 ...
 */
class AK::AKAnimation : public AKObject
{
public:
     ...
     */
    using Callback = std::function<void(AKAnimation*)>;
     ...
     */
    AKAnimation(UInt32 durationMs = 0, const Callback &onUpdate = nullptr, const Callback &onFinish = nullptr) noexcept;
