...
{
    AKWeak<MPopup> role { static_cast<MPopup*>(data) };
    ...
    const bool update { role->MSurface::imp()->flags.check(MSurface::Imp::PendingFirstConfigure) };
...
{
    AKWeak<MPopup> popup { static_cast<MPopup*>(data) };
